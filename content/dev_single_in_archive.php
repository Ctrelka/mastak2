...
//		$content_back     = carbon_get_post_meta( $id, "content_back" );
		...
		$technologies_list = carbon_get_post_meta( $id, "technologies_list" );
		$line_color_start  = carbon_get_post_meta( $id, "line_color_start" );
		$line_color_end    = carbon_get_post_meta( $id, "line_color_end" );

		$hex_tech_color_start = carbon_get_post_meta( $id, "tech_color_start" );
		$hex_tech_color_end   = carbon_get_post_meta( $id, "tech_color_end" );
		$rgb_ts               = carbon_hex_to_rgba( $hex_tech_color_start );
		$rgb_te               = carbon_hex_to_rgba( $hex_tech_color_end );

		$mac_book_exam = carbon_get_post_meta( $id, "mac_book_exam" );
		$iphone_exam   = carbon_get_post_meta( $id, "iphone_exam" );
		$front_of_mac  = carbon_get_post_meta( $id, "front_of_mac" );
